...
class MLXInference(ModelInference):
    ...
    def _prepare_messages(self, file_path, input_data, apply_annotation, ocr_callback):
        ...
        """
        if any(name in self.model_name.lower() for name in ["mistral", "ministral", "deepseek", "dots", "gemma"]):
            ...
            raise ValueError("Unsupported model type. Please use Mistral, Ministral, DeepSeek, Gemma, dots.ocr or Qwen.")
