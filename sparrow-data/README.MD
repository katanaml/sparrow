...
3. Run data preparation task for Donut model fine-tuning. This task will create metadata and train, validation and test datasets for Donut model fine-tuning.
