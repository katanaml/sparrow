...
💬 **Instruction Calling**: Beyond document extraction - text processing, validation, decision making. Using LLMs, such as GPT-OSS, GLM Flash, etc.  
...
🚀 **Local Vision LLMs**: Mistral, QwenVL, DeepSeek OCR, dots.ocr, etc.  
