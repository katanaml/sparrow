...
* **[sparrow-ml-llm](https://github.com/katanaml/sparrow/tree/main/sparrow-ml/llm)** - Service for the LLM RAG pipeline, this is the main Sparrow service for data extraction and document processing.
