...
* **[sparrow-ml-lemming](https://github.com/katanaml/sparrow/tree/main/sparrow-ml/llm)** - A specialized service for the LLM RAG pipeline, enhancing the capabilities of language model processing.
